...
import { Plus, FileText, AlertTriangle, BarChart3, CheckCircle, Clock, Tags, Wallet, Trash2, Pencil, Search } from "lucide-react";
                                            ...
                                            <>
                                                ...
                                                {/* Add an icon inside the search input if desired */}
                                                    ...
                                                    <input
                                                        type="text"
                                                        value={searchQuery}
                                                        placeholder="Search expenses by date, property, unit, vendor, or category..."
