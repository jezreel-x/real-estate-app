...
const ApartmentForSaleDetails = () => {
    ...
    useEffect(() => {
        ...
        const listing = localStorage.getItem("selectedApartment");
        if (listing) {
            setHouse(JSON.parse(listing));

            // Filter out the selected listing from all listings to get similar apartments
            const allListings = JSON.parse(localStorage.getItem("apartmentsForSale")) || [];
    ...
    return (
        <div className="flex flex-col w-full mx-auto min-h-screen">
            ...
            <div className="flex mt-24 mb-4 p-6 items-center">
                ...
                <Link to="/apartments-for-sale" className="text-gray-900 font-semibold hover:text-[rgb(0,0,122)] flex items-center justify-center text-lg sm:text-xl">
                    Apartments For Sale
                </Link>
            </div>
            ...
            <div className="mt-8">
                <h2 className="text-2xl font-semibold text-gray-800 mb-4 px-6">Similar Apartments</h2>
...
export default ApartmentForSaleDetails;